...
- POST /scenes: {idempotencyKey,externalTraceId,bindings,producerId,startedAt,input?,sessionId?,observedUserId?} -> {id,captureRevision}. One scene per project/externalTraceId. Same create key/body returns original.
