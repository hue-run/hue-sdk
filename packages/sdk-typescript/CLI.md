...
overrides the origin. Telemetry content capture stays off unless `--content` is passed; pass it to
record full traces. In one-shot mode it also decides whether case outputs, error messages and explanations are persisted
