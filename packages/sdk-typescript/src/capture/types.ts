...
/** Explicit initial snapshot or before-image captured before the corresponding operation. */
export type StateEvidence = {
  ...
  adapter: "gmail@1" | "slack@1";
  /** Discriminator for this record variant. */
  kind: "initial_snapshot" | "before_image";
  ...
  boundary: {
    /** Boundary phase of the observation or state snapshot. */
    phase: "pre_execution" | "before_operation";
    /** Identity linking this record to its observed call. */
    callId?: string;
