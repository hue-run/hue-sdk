...
- `adapter`: `gmail@1` or `slack@1`, plus service, account, actor, and optional resource identity.
- `kind`: `initial_snapshot` or `before_image`.
- `boundary`: `pre_execution` or `before_operation`, optional call identity, complete collections, and known omissions.
