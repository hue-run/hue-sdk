...
The published TypeScript package is
[`0.6.0`](https://github.com/hue-run/hue-sdk/releases/tag/typescript-v0.6.0), with
product-named eval set, evaluator, run and scoring client methods, `hue eval --case`,
`runLocalAgent()`, V2 environments and the local
[setup CLI core](./packages/sdk-typescript/CLI.md). The published Python package is
[`0.3.0`](https://github.com/hue-run/hue-sdk/releases/tag/python-v0.3.0), with the same
